...
public class Menu {
    ...
    private void drawMenu(Screen screen) {
        ...
        graphics.setBackgroundColor(TextColor.ANSI.BLUE); // Set default background color
        screen.clear();
        ...
        for (int i = 0; i < Menu_options.length; i++) {
            ...
            if (i == selectedOption) {
                graphics.setBackgroundColor(TextColor.ANSI.MAGENTA); // Set background color for selected option
                graphics.putString(10, y, "> " + Menu_options[i]);
            } else {
                graphics.setBackgroundColor(TextColor.ANSI.BLUE); // Reset background color for non-selected options
